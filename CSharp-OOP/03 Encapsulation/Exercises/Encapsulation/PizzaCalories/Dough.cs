...
namespace PizzaCalories
{
    public class Dough
    {
        ...
        {
            var flourTypeValue = this.validFlourTypes[this.FlourType.ToLower()];
            var bakingTypeValue = this.validBakingTechniques[this.BakingTechnique.ToLower()];

            return BaseDoughtCalories * this.Weight * flourTypeValue * bakingTypeValue;
        }

        private void SeedflourTypes()
        {
            this.validFlourTypes.Add("white", 1.5);
            this.validFlourTypes.Add("wholegrain", 1);
        }
        ...
        private void SeedBakingTechniques()
        {
            ...
            this.validBakingTechniques.Add("homemade", 1);
        }
    }
}
