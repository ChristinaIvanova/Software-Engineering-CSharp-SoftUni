    ...
    class StartUp
    {
        ...
        static void Main(string[] args)
        {
            ...
            using (connection)
            {
                ...
                {
                    Console.WriteLine($"There was error while creating database: {e.Message}!");
                    return;
                }
            }
            ...
            using (connection)
            {
                ...
                {
                    Console.WriteLine($"There was error while creating tables: {e.Message}!");
                    return;
                }
                ...
                var insertValuesCmd = new SqlCommand(queryText, connection);

                try
                {
                    var rowsAffected = insertValuesCmd.ExecuteNonQuery();
                    Console.WriteLine($"Inserted data values. {rowsAffected} rows affected!");
                }
                catch (Exception e)
                {
                    Console.WriteLine($"There was error while inserting values: {e.Message}!");
                    return;
                }
            }
        }
